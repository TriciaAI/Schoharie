    ...
    <footer id="colophon" class="site-footer" role="contentinfo">
        ...
        <div class="site-info">
            <div class="container">
                ...
                <?php endif; ?>
                <?php printf(esc_html__('Content copyright %1$s %2$s %3$s', 'onepress'), '&copy;', esc_attr(date('Y')), esc_attr(get_bloginfo())); ?>
        <br>
        
        
        <?php printf(esc_html__('%1$s theme ', 'onepress'), '<a href="' . esc_url('https://www.famethemes.com/themes/onepress', 'onepress') . '">OnePress</a>', 'FameThemes'); ?>
           
                
                <p>customized by <a href="http://www.TriciaIsham.com">TriciaIsham.com</a>   
